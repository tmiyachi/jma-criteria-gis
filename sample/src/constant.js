...
/** 基準値タイルのホスト */
export const CRITERIA_HOST = JMA_CRITERIA_HOST ?? 'http://localhost'; // eslint-disable-line no-undef
/** 基準要素 */
...
/** ソース情報に表示するリンク */
export const ATTRIBUTION_JMAGIS =
  '<a href="https://www.data.jma.go.jp/developer/gis.html" target="_blank>気象庁「予報区等GISデータ」</a>、' +
  '<a href="https://www.jma.go.jp/jma/kishou/know/kijun/index.html" target="_blank>気象庁「特別警報の指標及び危険警報・警報・注意報発表基準一覧表」を加工して作成';
/** ソース情報に表示するリンク */
export const ATTRIBUTION_GIS =
...
export const OPTIONS = Object.freeze([
  ...
  {
    text: 'レベル4大雨危険警報の表面雨量指数基準値（危険警報対象のみ）',
  ...
  { text: 'レベル3大雨注意報の流域雨量指数基準値', value: 'rainri,lv3' },
  {
  ...
  {
    text: 'レベル4大雨危険警報の流域雨量指数基準値（危険警報対象のみ）',
